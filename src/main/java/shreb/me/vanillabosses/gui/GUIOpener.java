...
public class GUIOpener {
    ...
    private void initializeInventories(){
        ...
        trueFalse.addItem(createGuiItem(Material.GREEN_CONCRETE, "Set to True"));
        trueFalse.addItem(createGuiItem(Material.RED_CONCRETE, "Set to False"));
        trueFalse.addItem(createGuiItem(Material.ARROW, "Cancel"));

        stringEntering.addItem(createGuiItem(Material.PAPER, "Confirm entry", "Have a named item in your hand to set that name"));
        stringEntering.addItem(createGuiItem(Material.ARROW, "Cancel"));

        intEntering.addItem(createGuiItem(Material.PAPER, "Confirm entry", "Have a named item in your hand to set that number"));
        intEntering.addItem(createGuiItem(Material.ARROW, "Cancel"));

        doubleEntering.addItem(createGuiItem(Material.PAPER, "Confirm entry", "Have a named item in your hand to set that number"));
        doubleEntering.addItem(createGuiItem(Material.ARROW, "Cancel"));
        ...
        guiInventories.add(bossBasicSettings);
